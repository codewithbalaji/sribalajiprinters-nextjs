  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: process.env.NEXT_PUBLIC_WEB3FORM_URL,
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-md">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <button
                  ...
                  className="bg-balaji-purple hover:bg-balaji-purple/90 text-white px-8 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <svg
                      ...
                      className="h-10 w-10 text-balaji-purple mr-3 mt-1"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
